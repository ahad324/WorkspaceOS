...
export default function DashboardView({ isMcpRunning, setIsMcpRunning, activeWorkspace }: DashboardViewProps) {
  return (
          ...
          return (
            <div key={i} className="p-4 bg-surface-primary border border-border-subtle rounded-xl flex flex-col justify-between shadow-sm">
              ...
              <div className="mt-2.5">
                <span className="text-xl font-bold tracking-tight truncate block">{stat.value}</span>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center bg-bg-app p-3 rounded-lg border border-border-subtle">
                ...
                <span className={`px-2 py-0.5 text-[10px] font-bold rounded ${activeWorkspace ? 'bg-success-main/10 text-success-main' : 'bg-text-muted/10 text-text-muted'}`}>
          ...
          <div>
            ...
            <div className="border border-dashed border-border-subtle rounded-lg flex flex-col items-center justify-center py-10 text-center px-4">
              ...
              <h4 className="text-xs font-semibold">
                {activeWorkspace ? 'Workspace Bounded & Shielded' : 'Waiting for connection...'}
              </h4>
